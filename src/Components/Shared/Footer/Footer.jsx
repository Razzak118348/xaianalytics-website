        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 items-start">
          ...
          <div className="md:col-span-5 space-y-4 flex flex-col items-center md:items-start text-center md:text-left mb-4">
            ...
            <div className="space-y-1">
              <h3 className="font-cinzel font-bold text-lg text-center">
                XaiResAiBusAnalytics
              </h3>
              <p className="text-xs text-base-content/60 max-w-sm leading-relaxed">
                Studies in International Series in Operations Research & Management Science. Indexed by Web of Science (WoS).
              </p>
            </div>
          </div>
          ...
          <div className="md:col-span-7 space-y-4 w-full">
            <h4 className="font-black text-primary text-center md:text-left flex items-center justify-center md:justify-start gap-2">
              <FiMail className="text-secondary" /> For questions regarding the book,please contact
            </h4>
...
<div className="flex flex-col gap-2 mt-4">
  <a
              ...
              {/* Editor Group 2 */}
              <div className="bg-base-200/60 p-4 rounded-xl border border-base-200 hover:border-primary/20 transition-all duration-200 flex flex-col justify-center">
                <p className="font-bold ">
